...
$questions = [
  [
    ...
    "choice3" => "végétarien (pas de viande, mais des produits d’origine animale comme les oeufs, le lait ou le fromage)",
  ...
  <form action="results.php" method="post">
    ...
    ?>
      ...
      <div>
        ...
        <p class="form-check">
          <input class="form-check-input" type="radio" id="choice1" name="q<?= $i ?>" value="<?= $question["result1"] ?>">
          <label class="form-check-label" for="q<?= $i ?>"><?= $question["choice1"] ?></label>
        </p>
        <p class="form-check">
          <input class="form-check-input" type="radio" id="choice2" name="q<?= $i ?>" value="<?= $question["result2"] ?>">
          <label class="form-check-label" for="q<?= $i ?>"><?= $question["choice2"] ?></label>
        </p>
        <p class="form-check">
          <input class="form-check-input" type="radio" id="choice3" name="q<?= $i ?>" value="<?= $question["result3"] ?>">
          <label class="form-check-label" for="q<?= $i ?>"><?= $question["choice3"] ?></label>
        </p>
        <p class="form-check">
          <input class="form-check-input" type="radio" id="choice4" name="q<?= $i ?>" value="<?= $question["result4"] ?>">
